...
#%%SOM
som = MiniSom(n, n, size,neighborhood_function='gaussian', sigma=20, random_seed=1,learning_rate=0.5) # Initialization of nxn SOM
som.pca_weights_init(data) #Starting weights from first two Principal Components
som.train_random(data, 100000) #100 training iterations
